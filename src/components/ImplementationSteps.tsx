...
export const themes: Theme[] = [
  ...
  {
    id: 'theme-2',
    title: 'Rozšíření TreeInfo o schválení představenstvem',
  ...
  {
    id: 'theme-3',
    title: 'Schválení jakéhokoli jiného bodu programu představenstvem',
    description: 'Univerzální schvalovací systém pro všechny typy agend správní rady',
    steps: [
      { 
        id: 'step-3-1', 
        title: 'Analýza možností', 
        description: 'Analýza požadavků na univerzální schvalovací systém',
        details: [
      ...
      { 
        id: 'step-3-2', 
        title: 'Prezentace procesu', 
        description: 'Prezentace univerzálního schvalovacího modelu',
        details: [
      ...
      { 
        id: 'step-3-3', 
        title: 'Rozšíření PowerApps prostředí', 
        description: 'Rozšíření stávajícího systému o univerzální funkcionalitu',
        details: [
      ...
      { 
        id: 'step-3-4', 
        title: 'Implementace univerzální logiky', 
        description: 'Vývoj flexibilního schvalovacího systému',
        details: [
      ...
      { 
        ...
        description: 'Rozšíření dokumentace o univerzální funkcionalitu',
        details: [
      ...
      { 
        id: 'step-3-6', 
        title: 'Pilotní testování', 
        description: 'Testování univerzálního systému na vybraných agenách',
        details: [
      ...
      { 
        id: 'step-3-7', 
        title: 'Postupné nasazení', 
        description: 'Postupné rozšíření na všechny typy agend',
        details: [
