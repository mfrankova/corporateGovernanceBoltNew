...
export const openQuestions: OpenQuestion[] = [
 
  {
    ...
    context: 'Cílem této otázky je stanovit požadovanou úroveň transparentnosti při hlasování správní rady. Je třeba rozhodnout, zda bude zobrazováno pouze potvrzení vlastního   hlasu člena, nebo budou dostupné i informace o účasti a konkrétním způsobu hlasování ostatních členů, a tím i plná transparentnost celého procesu.',
    priority: 'kritické'
  },
  {
