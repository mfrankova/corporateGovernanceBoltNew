...
export const openQuestions: OpenQuestion[] = [
  {
    ...
    context: 'Je třeba vyjasnit nastavení způsobu schvalování agendy správní radou mimo standardní procesy. Cílem je rozhodnout, zda: 1. Bude vždy využíván plný proces hlasování všech členů správní rady, nebo 2. Se zvolí zjednodušený model, kdy postačí souhlas předsedy a místopředsedy, a to s ohledem na efektivitu, úsporu času a snížení administrativních nákladů.',
    priority: 'kritické'
  },
  {
